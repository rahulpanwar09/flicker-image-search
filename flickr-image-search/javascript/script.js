let obj = (function () {
    ...
    function getAPI(search, pageNumber) {
        return `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${insert_your_key}&text=${search}&page=${pageNumber}&format=json&nojsoncallback=1`;
    }
